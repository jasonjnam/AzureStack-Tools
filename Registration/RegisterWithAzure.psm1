...
[CmdletBinding()]
    ...
    $AzToken = Get-AzToken -fromCache -verbose
    $Token = @{ 
        RefreshToken = $AzToken.GetRefreshToken()
    }
    $ret = @{
        TenantId = $AzureContext.Subscription.TenantId
        Token = $Token
    }
    Log-Output "AzureAccountInfo:`r`n$(ConvertTo-Json $ret)"
    return $ret
}
...
[CmdletBinding()]
    ...
    do
    {
        try
        {
            ...
            [Version]$azurePSVersion = (Get-Module Az.Resources).Version
